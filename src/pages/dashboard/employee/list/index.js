...
/*    const deleteHandler = async (id, name) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: "status",
            key: "status",
            render: (value) =>  value === 'active' ?  <span style={{color: 'forestgreen'}}>{value.toUpperCase()}</span> :  <span style={{color: 'orangered'}}>{value.toUpperCase()}</span>,
        },
        {
            title: "Verified",
            dataIndex: "verified",
            key: "verified",
            render: (value) => value ? <span style={{color: 'forestgreen'}}>VERIFIED</span> : <span style={{color: 'orangered'}}>NOT VERIFIED</span>,
        },
        {
            title: "Created Date",
            dataIndex: "createdAt",
        ...
        },
        {
            title: "Action",
            dataIndex: "_id",
            render: (id, data) => <Space wrap key={id}>
