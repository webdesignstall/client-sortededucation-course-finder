...
const columns = [
    {
        ...
        key: 'university',
        render: (university) => <Image width={300} height={120} src={university?.logo?.secure_url} alt={university?.name}/>
    },
    {
        title: 'Qualification',
                ...
                <div className='container page-space search-result'>
                    <Row>
                        <Col xs={24} sm={24} md={24}>
                            {courses?.length ? <Table className='search-table' columns={columns} dataSource={courses}/> : <Skeleton></Skeleton>}
